...
from infrastructure.ai.openai_client import sub_model, deepseek_model
...
comprehensive_service_agent = Agent(
    name="全能业务智能体",
    instructions=load_prompt("service_agent"),
    model=sub_model,
