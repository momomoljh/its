...
from infrastructure.ai.openai_client import sub_model, deepseek_model, main_model
from infrastructure.tools.local.baidu_service_station import (
...
comprehensive_service_agent = Agent(
    name="全能业务智能体",
    instructions=load_prompt("baidu_service_agent"),
...
async def main():
    ...
    test_cases = [
        ...
        # ("Case 5普通 POI - 起点不明确 终点明确", "天安门广场都有哪些商场？"),
